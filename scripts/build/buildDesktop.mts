/*
 * Globalcord, a desktop app aiming to give you a snappier Discord Experience
...
await Promise.all([
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/globalcord/main/index.ts"],
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/globalcord/preload/index.ts"],
        outfile: "dist/js/preload.js",
        footer: { js: "//# sourceURL=VesktopPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/globalcord/preload/splash.ts"],
        outfile: "dist/js/splashPreload.js",
        footer: { js: "//# sourceURL=VesktopSplashPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/globalcord/preload/updater.ts"],
    ...
    createContext({
        ...CommonOpts,
        globalName: "Equibop",
        entryPoints: ["src/globalcord/renderer/index.ts"],
        outfile: "dist/js/renderer.js",
        format: "iife",
        inject: ["./scripts/build/injectReact.mjs"],
        jsxFactory: "VencordCreateElement",
        jsxFragment: "VencordFragment",
        external: ["@Globalcord/types/*", "@globalcord/types/*"],
        plugins: [vencordDep, includeDirPlugin("patches", "src/globalcord/renderer/patches")],
