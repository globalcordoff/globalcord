# ==============================================================================
#  Globalcord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Globalcord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Globalcord-Client"
...
Write-Host "  ║      GLOBALCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Globalcord désinstallé avec succès !                 │" -ForegroundColor Green
