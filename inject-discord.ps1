# ==============================================================================
#  Globalcord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Globalcord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Globalcord
$GlobalcordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$GlobalcordPatcher = $GlobalcordPatcher.Replace("\", "\\")
...
// Injection Globalcord
try {
    require(\"$GlobalcordPatcher\");
} catch (e) {
    console.error(\"Globalcord injection failed:\", e);
