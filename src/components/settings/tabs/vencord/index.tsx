...
import { ContributeModal } from "../../../../globalcord/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of Globalcord."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of Globalcord."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the Globalcord team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for Globalcord."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the Globalcord team."
    }
];
    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="Globalcord Server"
                    action={() => window.open("https://discord.gg/globalcord", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("globalcord-stealth-change", handler);
        return () => window.removeEventListener("globalcord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all Globalcord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all Globalcord visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Globalcord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Globalcord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all Globalcord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "Globalcord Settings");
