...
const REPO_URL = "https://github.com/globalcordoff/globalcord";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>Globalcord Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of Globalcord. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://globalcord.online" style={{ fontSize: 13 }}>
                                globalcord.online
                            </Link>
                        </div>
                    </div>
