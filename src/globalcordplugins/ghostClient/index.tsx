...
const DS_KEY_TOKENS = "globalcord-ghost-tokens";
const DS_KEY_AUTO_FOLLOW = "globalcord-ghost-autofollow";
const DS_KEY_MIC_DEVICE = "globalcord-ghost-mic-device-label";
const DS_KEY_SELECTED = "globalcord-ghost-selected";
