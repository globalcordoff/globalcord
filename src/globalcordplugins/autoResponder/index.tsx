...
import { getGroqKey,groqChat } from "../globalcordAI/groqManager";
            ...
            <div style={{
                ...
                <div>
                    ...
                    <div style={{ fontSize: "13px", marginTop: "4px" }}>
                        ...
                        Please configure it once in the <strong>GlobalcordAI</strong> settings.
                    </div>
                </div>
            </div>
        )
        ...
        if (!apiKey) {
            try {
                ...
                openConfirmationModal({
                    ...
                    content: "AutoResponder requires a Groq API Key to function. Please configure it once in the GlobalcordAI settings.",
                    confirmText: "Configure GlobalcordAI",
                    cancelText: "Cancel",
                    onConfirm: () => {
                        const { openModal } = findByPropsLazy("openModal");
                        // Logique pour ouvrir les settings GlobalcordAI si possible
                    }
                });
            } catch (e) {
