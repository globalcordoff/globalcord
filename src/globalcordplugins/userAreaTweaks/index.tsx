...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for Globalcord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "Globalcord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "globalcord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("globalcord-userarea-tweaks-style")?.remove();
    }
});
