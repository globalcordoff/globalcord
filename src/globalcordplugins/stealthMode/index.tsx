...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in Globalcord Settings.",
    ...
    stop() {
        document.body.classList.remove("globalcord-stealth");
    },
});
