...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/globalcordoff/globalcord/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[GlobalcordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[GlobalcordUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.globalcord?.relaunch?.();
                } catch {
            ...
            console.error("[GlobalcordUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 Globalcord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("globalcord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "globalcord-updater-root";
    ...
    try {
        ...
        console.error("[GlobalcordUpdater] Error montage bannière:", e);
    }
}
