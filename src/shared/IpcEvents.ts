...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "GlobalcordSetWindowBackgroundMaterial",
    ...
    // Globalcord Updater — télécharge un exe depuis une URL et le lance
    GLOBALCORD_DOWNLOAD_AND_RUN = "GlobalcordDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "GlobalcordCheckVBCable",
    INSTALL_VB_CABLE = "GlobalcordInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "GlobalcordRelaunchApp",
