...
const GlobalcordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(GlobalcordDir, "Uninstall Globalcord.exe"));

export const DATA_DIR =
    process.env.Globalcord_USER_DATA_DIR || (PORTABLE ? join(GlobalcordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Globalcord/${app.getVersion()} (https://github.com/Globalcord/Globalcord)`;
