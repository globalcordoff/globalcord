...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/Globalcord/Globalcord/releases/latest/download/Globalcord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Globalcord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled globalcord.asar not found at", VENCORD_DIR);
    }
}
