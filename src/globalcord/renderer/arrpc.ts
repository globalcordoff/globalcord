...
import { Logger } from "@Globalcord/types/utils";
import { findLazy, onceReady } from "@Globalcord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Globalcord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("GlobalcordRPC", "#5865f2");
