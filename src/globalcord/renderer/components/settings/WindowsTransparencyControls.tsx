...
import { Heading, Paragraph } from "@Globalcord/types/components";
import { Margins } from "@Globalcord/types/utils";
import { Select } from "@Globalcord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Globalcord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
