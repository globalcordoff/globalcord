...
import { BaseText } from "@Globalcord/types/components";
import { React, useRef,useState } from "react";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "globalcord" | "unknown" {
    ...
    // Plugins spécifiques à Globalcord
    if (pluginNames.some(p => ["GlobalcordHelper", "equicordHelper"].includes(p))) return "globalcord";
...
function cleanForGlobalcord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Globalcord
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "globalcord" ? "Globalcord" : "inconnu";

            const cleaned = cleanForGlobalcord(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Globalcord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Globalcord.
                Plugin-specific settings that don't exist in Globalcord will be automatically removed.
            </BaseText>
