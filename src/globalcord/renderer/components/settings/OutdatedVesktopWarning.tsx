...
import { Button, Card, HeadingTertiary, Paragraph } from "@Globalcord/types/components";
import { useAwaiter } from "@Globalcord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Globalcord is outdated!</HeadingTertiary>
