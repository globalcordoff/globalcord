...
import { useState } from "@Globalcord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Globalcord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Globalcord minimized when starting with system"}
