...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Globalcord/types/components";
import { FluxDispatcher, InviteActions } from "@Globalcord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Globalcord and Globalcord are fully up to date. You can get help in our{" "}
