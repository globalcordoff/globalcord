...
import { Button, Flex, Heading, Paragraph } from "@Globalcord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Globalcord/types/utils";
import { React } from "@Globalcord/types/webpack/common";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        Globalcord is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => window.open("https://discord.gg/globalcord", "_blank")}
                            >
                                discord.gg/globalcord
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download Globalcord via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
