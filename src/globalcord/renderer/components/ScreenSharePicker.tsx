...
import {
    ...
    RestartIcon,
    Span
} from "@Globalcord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { onceReady } from "@Globalcord/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Globalcord/types/webpack/common";
...
const logger = new Logger("GlobalcordScreenShare");
