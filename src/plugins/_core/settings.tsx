...
import { CreateThemeTab } from "@globalcordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@globalcordplugins/createTheme/components/PencilSparkleIcon";
import IconsTab from "@globalcordplugins/iconViewer/components/IconsTab";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Globalcord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const mainEntry = buildEntry({
            key: "equicord_main",
            title: "Globalcord",
            panelTitle: "Globalcord Settings",
    ...
    getInfoRows() {
        ...
        const rows = [`Globalcord ${gitHashShort}${getVersionInfo()}`];
