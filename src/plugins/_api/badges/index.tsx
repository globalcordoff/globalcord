...
let GlobalcordBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const globalcordBadges = await loadBadges("https://gist.githubusercontent.com/globalcordoff/29ff0da4ebd5a7e36acdf97be24f28c9/raw/badges.json", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    GlobalcordBadges = globalcordBadges;
}
...
export default definePlugin({
    ...
    get GlobalcordBadges() {
        return GlobalcordBadges;
    },
    ...
    getGlobalcordBadges(userId: string) {
        try {
            const userBadges = GlobalcordBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "Globalcord Badge",
