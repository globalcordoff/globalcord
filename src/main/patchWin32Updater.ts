...
function patchLatest() {
    try {
        ...
        console.info("[Globalcord] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), "// Globalcord repatch\n\"use strict\";\nconst path = require(\"path\");\nrequire(path.join(__dirname, \"..\", \"app\", \"dist\", \"desktop\", \"patcher.js\"));");
    } catch (err) {
        console.error("[Globalcord] Failed to repatch latest host update", err);
    }
}
